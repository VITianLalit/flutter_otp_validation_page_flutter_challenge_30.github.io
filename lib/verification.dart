        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 30,),
              Text("Please enter the 6 digit code sent to \n +91 000-000-000", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Colors.grey.shade500, height: 1.5),),
              SizedBox(height: 30,),
              VerificationCode(
                length: 6,
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(_isResendAgain? "Try again in "+ _start.toString():"Resent", style: TextStyle(color: Colors.blueAccent),),
                  ),
                ],
              ),
              SizedBox(height: 50,),
